...
use crate::spartan::{powers, PolyEvalInstance, PolyEvalWitness};
use crate::traits::commitment::{CommitmentEngineTrait, CommitmentTrait};
use crate::traits::evaluation::EvaluationEngineTrait;
use crate::traits::Group;
use crate::traits::TranscriptEngineTrait;
use crate::{errors::NovaError, CommitmentKey};
use crate::{Commitment, CompressedCommitment};
use ff::Field;
...
impl<G: Group, EE: EvaluationEngineTrait<G>> DigestBuilder<G::Scalar, VerifierKey<G, EE>> {
  fn setup(vk_ee: EE::VerifierKey, table_size: usize, comm_init_value: Commitment<G>) -> Self {
    let vk = VerifierKey {
      vk_ee,
  ...
  <G::Scalar as PrimeField>::Repr: Abomonation,
{
  pub fn setup(
    ...
    let vk =
      DigestBuilder::<G::Scalar, VerifierKey<G, EE>>::setup(vk_ee, table_size, comm_init_value)
        .build()
